...
| eCARTv Clinical Deterioration Suite (“eCART”) | K233253 | 510(k) | Machine Learning | Hospital deterioration prediction and early warning | 38.6 to 51.8 * | 93.1 to 96.9 * | NR | 79.2 | 12.6 | 1.9 | 0.4 AI/AN; 0.2 NH/PI; 5.8 Unknown |
Dental
|
|||||||||||
...
| Us2.v | K233676 | 510(k) | NR | Ultrasound image processing for cardiovascular analysis | NR | NR | 45.8 to 55.8 * | 18.8 to 87.9 * | 3.7 to 25 * | NR | 0 to 25.8 Hispanic *; 7.7 to 13.4 Other * |
