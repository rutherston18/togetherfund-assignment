...
Digital interfaces are increasingly being rolled out to help triage patients, too. In an insight report from 2024, part of the World Economic Forum’s Digital Healthcare Transformation Initiative, a case study on digital patient platform Huma, revealed it could reduce readmission rates by 30%, time spent reviewing patients by up to 40% and “alleviated the workload of healthcare providers”.
...
Practiced in 170 countries and used by billions of people, traditional medicine has maintained its relevance in the modern world in part because of its emphasis on a holistic approach to healthcare. And while AI and traditional medicine might seem an unlikely pairing at first, studies demonstrate the two can complement each other well. A new brief from the World Health Organization (WHO) and partners, 'Mapping the application of artificial intelligence in traditional medicine', shows how AI can enhance traditional, complementary and integrative medicine (TCIM) while protecting cultural heritage.

India is the first country to launch a traditional knowledge digital library, utilizing AI tools to catalogue and analyze indigenous medical texts. The country is also exploring how AI and Ayurgenomics - a field which combines the ancient Indian medical system of Ayurveda with modern genomics - can intersect, to see what herbal formulations could help tackle modern diseases.

Similarly, in Ghana, researchers are using a learning model to help identify and classify medicinal plants, while in South Korea, AI is being used to analyze traditional medicine compounds to treat blood disorders.

The global TCIM market is expected to reach nearly $600 billion in 2025 - and AI looks set to accelerate that market further and faster. The new brief stresses the importance of safeguarding Indigenous data sovereignty in the process.
...
Of course, having an AI tool listening in and taking notes on your doctor's appointment will not appeal to everyone. A recent study in the UK found that just 29% of people would trust AI to provide basic health advice (although over two-thirds are comfortable with the technology being used to free up professionals' time). Then there is the question of accuracy. A report last year found that OpenAI's Whisper, used by many hospitals to summarize patient meetings, was hallucinating some of the transcriptions.
